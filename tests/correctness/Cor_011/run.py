...
class PySysTest(AnalyzerBaseTest):
	def execute(self):			
		self.logAnalyzer(['--statusjson'], logfiles=['correlator-java-errors.log'], stdouterr='loganalyzer_java')
		self.logAnalyzer(['--statusjson'], logfiles=['correlator-epl-errors.log', 'correlator-crash.log'], stdouterr='loganalyzer_nonjava')

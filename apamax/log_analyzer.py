...
class LogAnalyzer(object):
	...
	CHARTS = { # values are (mostly) for dygraph config
		...
		'health':{'heading':'Logging/consumers/swapping', 'ylabel':'Errors/warns logged (since last status), Consumers', 'y2label':'Is swapping (true=1)',
...
<p>Generated by Log Analyzer {version}. <a href=".">Click here</a> to see all generated files. For more information about the latest version of the analyzer <a href='https://github.com/ApamaCommunity/apama-log-analyzer'>see here</a>.</p>

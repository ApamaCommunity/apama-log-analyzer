...
<p>If you need to help analyzing a log file, here's the essential information you need to include: <ol>
<li>Apama Version: (TODO: 5-digit Apama version here)</li>
<li>Date/time(s) when problem occurred: (TODO: START to END; include date, time, and timezone)</li>
<li>Nature of the problem: (TODO: e.g. reduced performance, out of memory, correlator terminated unexpectedly, logic error in EPL monitor, confusing log message, etc)</li>
<li>Reproducibility: (TODO: How many times has the problem occurred and how frequently? Can it be reproduced in a test environment?)</li>
<li>Application experts: (TODO: What contacts/departments within Software AG and/or customer knows the codebase of the EPL application?)</li>
<li>Correlator logs: (TODO: Links to original correlator log files covering the time when the problem occurred, and also containing the period when it was started; this contains vital information)</li>
<li>Log analyzer overview output: (TODO: paste in a copy of the overview text below)</li>
</ol></p>
"""
